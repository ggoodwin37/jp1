...
+(NSString *)getSpriteNameForPreset:(EBlockPreset)preset
{
    switch( preset )
    {
        ...
        case EBlockPreset_tiny_creep_jelly_LR: return @"tiny-creep-jelly-0";
        case EBlockPreset_tiny_creep_jelly_UD: return @"tiny-creep-jelly-1";  // TODO: consider adding some edit hints for these.
